...
function turnleft() {
  ...
  if (
    scene.querySelector("#airlockobj").object3D.rotation.y == 0 ||
    scene.querySelector("#airlockobj").object3D.rotation.y == 360
  ) {
    console.log("0");
  } else if (
    scene.querySelector("#airlockobj").object3D.rotation.y ==
    Math.PI / 2
  ) {
    console.log("90");
    scene.querySelector("#airlockobj").object3D.position.z += 4;
  } else if (
    scene.querySelector("#airlockobj").object3D.rotation.y == Math.PI
  ) {
    console.log("180");
